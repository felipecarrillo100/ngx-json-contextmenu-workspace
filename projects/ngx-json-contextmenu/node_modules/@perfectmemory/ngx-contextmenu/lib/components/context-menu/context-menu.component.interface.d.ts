...
export interface ContextMenuAnchoredToPositionEvent<T> extends ContextMenuBaseEvent<T> {
    /**
...
export interface ContextMenuAnchoredToElementEvent<T> extends ContextMenuBaseEvent<T> {
    /**
...
export type ContextMenuOpenEvent<T> = ContextMenuAnchoredToPositionEvent<T> | ContextMenuAnchoredToElementEvent<T>;
 ...
 * @deprecated Not used any more
 */
export type ContextMenuCloseEvent<T extends Object = any> = ContextMenuExecuteEvent<T> | ContextMenuCancelEvent;
